...
function hookDomToUI() {
  ...
  ui.craftPanel = document.getElementById("craftPanel");
  ui.storagePanel = document.getElementById("storagePanel");
  ui.characterPanel = document.getElementById("characterPanel");
  ui.researchPanel = document.getElementById("researchPanel");
  ui.mapPanel = document.getElementById("mapPanel");
  ui.journalPanel = document.getElementById("journalPanel");
