...
const CombatScene = (() => {
  const ACTORS = {
    ...
    brokenWarden: { region: "west", place: "West · Arcane Archive", art: '<path d="M49 107 L39 163 70 166 80 124 92 165 124 164 115 103Z"/><path class="creature-limb" d="M42 49 L13 59 7 107 30 119 51 84Z"/><path d="M117 49 L146 60 151 113 130 123 108 84Z"/><path class="creature-body" d="M40 53 L60 40 105 40 126 56 112 119 50 119Z"/><path d="M60 12 L101 12 107 39 82 51 57 37Z"/><path class="creature-detail" d="M50 60 L72 75 61 106 M113 60 L93 75 104 106"/><path class="creature-core" d="M81 62 L95 83 82 106 68 83Z"/><path class="warden-shell" d="M49 55 L81 66 113 55 106 110 83 119 57 110Z"/><path class="warden-crack" d="M82 61 L70 78 91 86 75 100 83 117"/>' },
  };
